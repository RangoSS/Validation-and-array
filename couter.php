				...
				<div class="container">
					<div class="row">
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<div class="skill5-counter">
								<p class="counter-count">100</p>
								<p class="counter-bottom">HTML5</p>
							</div>
						</div>
			</div>
		</div>
...
<script>$('.counter-count').each(function(){$(this).prop('Counter',0).animate({Counter:$(this).text()},{duration:2000,easing:'swing',step:function(now){$(this).text(Math.ceil(now))}})})</script>		
